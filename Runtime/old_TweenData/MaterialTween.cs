...
//                    return mat.DOColor(color, property, duration);//done
//                case MaterialCommand.Fade:
//                    return mat.DOFade(to, duration);//done
//                case MaterialCommand.FadeProperty:
//                    return mat.DOFade(to, property, duration);//done
//                case MaterialCommand.Float:
//                    return mat.DOFloat(to, property, duration);//done
//                case MaterialCommand.GradientColor:
//                    return mat.DOGradientColor(gradient, duration);//done
//                case MaterialCommand.GradientColorProperty:
//                    return mat.DOGradientColor(gradient, property, duration);//done
//                case MaterialCommand.Offset:
//                    return mat.DOOffset(vector2, duration);//done
//                case MaterialCommand.OffsetProperty:
//                    return mat.DOOffset(vector2, property, duration);//done
//                case MaterialCommand.Tiling:
//                    return mat.DOTiling(vector2, duration);//done
//                case MaterialCommand.TilingProperty:
//                    return mat.DOTiling(vector2, property, duration);//done
//                case MaterialCommand.Vector:
//                    return mat.DOVector(vector4, property, duration);//done
...
//                    return mat.DOBlendableColor(color, property, duration);//done
//                default:
//                    return null;
//            }
//        }
